package de.ngloader.api.database.sql;
...
public final class SQLConnectionWrapper implements Connection {
	...
	public void close() throws SQLException {
		throw new SQLException("not allowed to close connection");
	}

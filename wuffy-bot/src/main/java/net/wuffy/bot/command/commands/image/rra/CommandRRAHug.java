...
@CommandSettings(
		...
		memberPermissionList = { PermissionKeys.COMMAND_HUG },
		memberPermissionRequierd = { PermissionKeys.COMMAND_HUG },
		aliases = { "hug" },
		privateChatCommand = true)
public class CommandRRAHug extends Command {

	public CommandRRAHug(CommandHandler handler) {
		super(handler);
	}
	...
	public void sendImage(WuffyMessageRecivedEvent event, String locale) {
		...
		String picture = RRABuilder.getRandom(EnumRRATypes.HUG);

...
@CommandSettings(
		...
		memberPermissionList = { PermissionKeys.COMMAND_LICK },
		memberPermissionRequierd = { PermissionKeys.COMMAND_LICK },
		aliases = { "lick" },
		privateChatCommand = true)
public class CommandRRALick extends Command {

	public CommandRRALick(CommandHandler handler) {
		super(handler);
	}

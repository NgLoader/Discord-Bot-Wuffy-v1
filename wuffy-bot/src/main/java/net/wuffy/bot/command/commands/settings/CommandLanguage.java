			...
			case "user":
				if(args.getSize() > 1) {
					if(args.get(1).equalsIgnoreCase("none") ||
							args.get(1).equalsIgnoreCase("null") ||
							args.get(1).equalsIgnoreCase("guild") ||
							args.get(1).equalsIgnoreCase("empty") ||
							args.get(1).equalsIgnoreCase("reset") ||
							args.get(1).equalsIgnoreCase("-")) {
						...
						Locale locale = LocaleUtil.getLocaleByTag(args.get(1));

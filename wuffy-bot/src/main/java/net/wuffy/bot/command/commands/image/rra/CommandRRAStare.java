...
@CommandSettings(
		...
		memberPermissionList = { PermissionKeys.COMMAND_STARE },
		memberPermissionRequierd = { PermissionKeys.COMMAND_STARE },
		aliases = { "stare" },
		privateChatCommand = true)
public class CommandRRAStare extends Command {

	public CommandRRAStare(CommandHandler handler) {
		super(handler);
	}

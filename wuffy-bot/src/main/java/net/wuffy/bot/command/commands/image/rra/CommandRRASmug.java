...
@CommandSettings(
		...
		memberPermissionList = { PermissionKeys.COMMAND_SMUG },
		memberPermissionRequierd = { PermissionKeys.COMMAND_SMUG },
		aliases = { "smug" },
		privateChatCommand = true)
public class CommandRRASmug extends Command {

	public CommandRRASmug(CommandHandler handler) {
		super(handler);
	}

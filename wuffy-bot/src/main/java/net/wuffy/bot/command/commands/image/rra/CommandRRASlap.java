...
@CommandSettings(
		...
		memberPermissionList = { PermissionKeys.COMMAND_SLAP },
		memberPermissionRequierd = { PermissionKeys.COMMAND_SLAP },
		aliases = { "slap" },
		privateChatCommand = true)
public class CommandRRASlap extends Command {

	public CommandRRASlap(CommandHandler handler) {
		super(handler);
	}
	...
	public void sendImage(WuffyMessageRecivedEvent event, String locale) {
		...
		String picture = RRABuilder.getRandom(EnumRRATypes.SLAP);

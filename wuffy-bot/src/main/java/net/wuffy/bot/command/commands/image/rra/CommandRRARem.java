...
@CommandSettings(
		...
		memberPermissionList = { PermissionKeys.COMMAND_REM },
		memberPermissionRequierd = { PermissionKeys.COMMAND_REM },
		aliases = { "rem" },
		privateChatCommand = true)
public class CommandRRARem extends Command {

	public CommandRRARem(CommandHandler handler) {
		super(handler);
	}
	...
	public void sendImage(WuffyMessageRecivedEvent event, String locale) {
		...
		String picture = RRABuilder.getRandom(EnumRRATypes.REM);

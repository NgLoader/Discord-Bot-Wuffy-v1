...
@CommandSettings(
		...
		memberPermissionList = { PermissionKeys.COMMAND_POUT },
		memberPermissionRequierd = { PermissionKeys.COMMAND_POUT },
		aliases = { "pout" },
		privateChatCommand = true)
public class CommandRRAPout extends Command {

	public CommandRRAPout(CommandHandler handler) {
		super(handler);
	}

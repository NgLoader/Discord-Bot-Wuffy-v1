...
@CommandSettings(
		...
		memberPermissionList = { PermissionKeys.COMMAND_PAT },
		memberPermissionRequierd = { PermissionKeys.COMMAND_PAT },
		aliases = { "pat" },
		privateChatCommand = true)
public class CommandRRAPat extends Command {

	public CommandRRAPat(CommandHandler handler) {
		super(handler);
	}
	...
	public void sendImage(WuffyMessageRecivedEvent event, String locale) {
		...
		String picture = RRABuilder.getRandom(EnumRRATypes.PAT);

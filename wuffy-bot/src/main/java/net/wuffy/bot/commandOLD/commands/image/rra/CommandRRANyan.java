...
@CommandSettings(
		...
		memberPermissionList = { PermissionKeys.COMMAND_NYAN },
		memberPermissionRequierd = { PermissionKeys.COMMAND_NYAN },
		aliases = { "nyan" },
		privateChatCommand = true)
public class CommandRRANyan extends Command {

	public CommandRRANyan(CommandHandler handler) {
		super(handler);
	}

...
@CommandSettings(
		...
		memberPermissionList = { PermissionKeys.COMMAND_KISS },
		memberPermissionRequierd = { PermissionKeys.COMMAND_KISS },
		aliases = { "kiss" },
		privateChatCommand = true)
public class CommandRRAKiss extends Command {

	public CommandRRAKiss(CommandHandler handler) {
		super(handler);
	}
	...
	public void sendImage(WuffyMessageRecivedEvent event, String locale) {
		...
		String picture = RRABuilder.getRandom(EnumRRATypes.KISS);

...
@CommandSettings(
		...
		memberPermissionList = { PermissionKeys.COMMAND_TRIGGERED },
		memberPermissionRequierd = { PermissionKeys.COMMAND_TRIGGERED },
		aliases = { "triggered" },
		privateChatCommand = true)
public class CommandRRATriggered extends Command {

	public CommandRRATriggered(CommandHandler handler) {
		super(handler);
	}

...
@CommandSettings(
		...
		memberPermissionList = { PermissionKeys.COMMAND_NOM },
		memberPermissionRequierd = { PermissionKeys.COMMAND_NOM },
		aliases = { "nom" },
		privateChatCommand = true)
public class CommandRRANom extends Command {

	public CommandRRANom(CommandHandler handler) {
		super(handler);
	}
	...
	public void sendImage(WuffyMessageRecivedEvent event, String locale) {
		...
		String picture = RRABuilder.getRandom(EnumRRATypes.NOM);

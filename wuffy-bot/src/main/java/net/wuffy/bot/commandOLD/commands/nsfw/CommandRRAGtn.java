package net.wuffy.bot.commandOLD.commands.nsfw;
...
import net.wuffy.bot.commandOLD.commands.image.rra.EnumRRATypes;
import net.wuffy.bot.commandOLD.commands.image.rra.RRABuilder;

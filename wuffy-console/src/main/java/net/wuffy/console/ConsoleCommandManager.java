...
import net.wuffy.console.commands.ConsoleCommandExit;
import net.wuffy.console.commands.ConsoleCommandHelp;
...
public class ConsoleCommandManager implements ITickable {
	...
	public ConsoleCommandManager() {
		this.registerExecutor(new ConsoleCommandHelp(this));

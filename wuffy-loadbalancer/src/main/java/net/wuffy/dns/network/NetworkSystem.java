...
import net.wuffy.dns.DNSConfig;
...
public class NetworkSystem extends AbstractServer implements ITickable {
	...
	public NetworkSystem start(DNSConfig.Master masterConfig, InetSocketAddress address) throws SSLException {
		...
		this.start(address, 0, new ChannelInitializer<Channel>() {
			...
			protected void initChannel(Channel channel) throws Exception {
				...
				NetworkSystem.this.networkManager.add(networkManager);
